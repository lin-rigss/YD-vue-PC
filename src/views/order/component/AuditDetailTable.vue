	...
	<div class="order-detail-table" >
		<el-table :data="tableData" height="100%" size="small">
			...
			<el-table-column label="单价">
				<template slot-scope="scope">
					<el-input size="mini" :min='1' type="number" disabled v-model="scope.row.offer"></el-input>
				</template>
			</el-table-column>
			<el-table-column label="审核单价">
				<template slot-scope="scope">
					<el-input size="mini" :min='1' type="number" v-model="scope.row.auditQuotation"></el-input>
				</template>
			</el-table-column>
			<el-table-column label="数量">
				<template slot-scope="scope">
					<el-input size="mini" :min='1' type="number" disabled v-model="scope.row.quantity"></el-input>
				</template>
			</el-table-column>

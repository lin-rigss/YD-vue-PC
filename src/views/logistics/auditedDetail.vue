			...
			<div class="order-content" :style="{height: 'calc(100% - 45px - ' + this.asideHeight + ')'}">
				<el-row :gutter="10" style="height: 100%;">
					<el-col :span="12" style="height: 100%;">
						<el-tabs v-model="activeName" style="height: 45%;">
						...
						<div style="height: 45%;margin-top:30px;">
							<span>发货图片：</span>
							<el-carousel arrow="always" :autoplay="false" :loop="false" height="100%">
								<el-carousel-item v-for="(img, index) in info.trackPhotosArr" :key="index">
									<div class="image-content">
										<img
											preview
											style="margin-top:10px;width: 100%;height:100%;"
					...
					<el-col :offset="2" :span="10" class="content-right" style="height: 100%;">
						...
						<div style="height: 45%;border: 1px solid #e6a23c59;margin-bottom:5%; text-align:right;">
							...
							<el-table :data="this.info.cgd" border size="small">
								...
								<el-table-column label="重量(kg)">
									<template slot-scope="scope">
										<el-input size="mini" :min='0' type="number" :disabled="!audit" v-model="scope.row.goodsWeight"></el-input>
									</template>
								</el-table-column>
						...
						<el-form label-width="80px" :model="info" style="height: 45%;border: 1px solid #e6a23c59;margin-bottom:20px;padding: 40px 10px;">
							<el-form-item label="重量(kg):">
								<el-input type='number' :min="0" v-model="info.weight" :disabled="!audit"></el-input>
							</el-form-item>
...
<script>
	export default {
		...
		mounted() {
			...
			// 获取订单详情
			this.$api.clue.orderDetail({id:this.id}).then(res => {
				this.info = res.data

		...
		<div class="inventory-put">
			...
			<div class="">
				<el-table :data="tableData" style="width: 100%" :size="config.size" :height="tableHeight" border>
					...
					<el-table-column min-width="180" label="入库单号" :align="config.align">
					...
					<el-table-column label="入库时间" width="120" :align="config.align">
						<template slot-scope="scope">
							{{ scope.row.stockDate }}
						</template>
					</el-table-column>
					<el-table-column label="入库类型" width="120" :align="config.align">
						<template slot-scope="scope">
							<div v-html="$g.dic.html('storage', scope.row.type)"></div>
						</template>
					</el-table-column>
					...
					<el-table-column prop="remarks" label="备注" width="180" :align="config.align"></el-table-column>
				</el-table>

	...
	<BasePage>
		<div class="factory-list">
			...
			<el-table :data="tableData" style="width: 100%" :size="config.size" :height="tableHeight" border>
				...
				<el-table-column prop="extendProperty.comName" label="拆解厂名称" min-width="200" :align="config.align" :show-overflow-tooltip="config.hidden"></el-table-column>
				...
				<el-table-column prop="extendProperty.comAddress" label="门店地址" min-width="300" :align="config.align" :show-overflow-tooltip="config.hidden"></el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			...
			list(){
				this.$api.factory.getList(this.form).then(res => {

<template>
	<BasePage>
		<div class="purchase-info">
			...
			<div class="form">
				<el-form label-width="140px" :model="form" ref="form" :rules="$g.rules.purchase">
					<!-- <el-form-item label="登录账号：" prop="account">
						<el-input v-model="form.account" placeholder="请输入企业账号" :disabled="type === 'detail'"></el-input>
					</el-form-item> -->
					<el-form-item label="买家名称：" prop="extendProperty.comName">
						<el-input v-model="form.extendProperty.comName" placeholder="请输入买家名称"></el-input>
					</el-form-item>
					<el-form-item label="买家描述：" prop="extendProperty.comDesc">
						<el-input type="textarea" v-model="form.extendProperty.comDesc" placeholder="请输入买家描述"></el-input>
					</el-form-item>
					<el-form-item label="买家地址：" prop="extendProperty.comAddress">
						<el-input type="textarea" v-model="form.extendProperty.comAddress" placeholder="请输入买家地址"></el-input>
					</el-form-item>
					<el-form-item label="买家联系人：" prop="extendProperty.comConcat">
						<el-input v-model="form.extendProperty.comConcat" placeholder="请输入联系人"></el-input>
					</el-form-item>
					<el-form-item label="联系人电话：" prop="extendProperty.comPhone">
						<el-input v-model="form.extendProperty.comPhone" placeholder="请输入手机号"></el-input>
					</el-form-item>
	...
	export default {
		...
		methods: {
			...
			submit(){
				...
				let that = this
				that.form.account = that.form.extendProperty.comPhone
